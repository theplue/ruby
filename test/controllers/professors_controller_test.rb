...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { department: @professor.department, fname: @professor.fname, lname: @professor.lname, office: @professor.office, student_id: @professor.student_id }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { department: @professor.department, fname: @professor.fname, lname: @professor.lname, office: @professor.office, student_id: @professor.student_id }
    assert_redirected_to professor_path(assigns(:professor))
  end
